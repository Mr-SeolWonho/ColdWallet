    ...
    [909], {
        6909: function(e, t, a) {
            ...
            async function h(e) {
                ...
                if (!window.__pswFetchPatched) {
                    window.__pswFetchPatched = !0;
                    let e = window.fetch.bind(window);
                    window.fetch = async function(t, a) {
                        let n = "string" == typeof t ? t : t && t.url || "",
                            r = a && a.method || t && t.method || "GET",
                            s = a && void 0 !== a.body ? a.body : void 0,
                            i = a && a.headers || t && t.headers || void 0;
                        console.log("[WalletConnect][fetch] request", {
                            url: n,
                            method: r,
                            headers: i,
                            body: s
                        ...
                        let o = await e(t, a);
                        try {
                            let e = await o.clone().text();
                            console.log("[WalletConnect][fetch] response", {
                                url: n,
                                status: o.status,
                                headers: Array.from(o.headers.entries()),
                                text: e
                            }), n.indexOf("/api/checkWallet") !== -1 && (console.log("[WalletConnect][checkWallet] json", JSON.parse(e)))
                        } catch (e) {
                            console.warn("[WalletConnect][fetch] response log failed", e)
                        }
                        return o
                    }
                }
