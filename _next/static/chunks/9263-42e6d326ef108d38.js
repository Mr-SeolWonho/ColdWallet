        ...
        99263: (e, t, n) => {
            ...
            function h() {
                ...
                return e ? (0, r.jsxs)(r.Fragment, {
                    children: [(0, r.jsx)(i(), {
                        id: "28131abc58c419c4",
                        children: '@keyframes spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@keyframes fadeIn{from{opacity:0;transform:translatey(20px)}to{opacity:1;transform:translatey(0)}}@keyframes pulse{0%{transform:scale(1);opacity:1}50%{transform:scale(1.05);opacity:.8}100%{transform:scale(1);opacity:1}}*{box-sizing:border-box;margin:0;padding:0;touch-action:manipulation}body{margin:0;background:#f6f5f4;font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;overflow-x:hidden;-webkit-tap-highlight-color:transparent;-webkit-text-size-adjust:100%;text-size-adjust:100%}textarea{font-family:inherit;font-size:16px!important;min-height:44px}input,button,textarea{font-family:inherit;font-size:16px!important}input[type="text"],input[type="email"],input[type="password"],input[type="number"]{font-size:16px!important;min-height:44px}button[data-phantom-primary="true"]{display:inline-flex;align-items:center;justify-content:center;height:58px;padding:0 22px;border:none;border-radius:32px;cursor:pointer;background:#8B5CF6;color:#fff;font-size:18px;font-weight:600;transition:.18s ease;box-shadow:inset 0 4px 24px rgba(255,255,255,.8),inset 0 -3px 12px rgb(255,218,235)}button[data-phantom-primary="true"]:hover{transform:translateY(-1px)}button[data-phantom-primary="true"]:active{transform:translateY(0) scale(.98)}@media(max-width:428px){body{font-size:14px}}'
                    }), (0, r.jsx)("div", {
                        style: {
                            position: "fixed",
                            inset: 0,
